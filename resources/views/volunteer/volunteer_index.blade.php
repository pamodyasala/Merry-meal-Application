      ...
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
            <img src="images/LOGO 2 new.png" style="width:300px;height:150px;">
              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Welcome Volunteer</h1>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="/vounteer_profile" class="smoothScroll">Profile</a></li>
                          ...
                          <div class="d-flex align-items-center">
                              ...
                              <div class="dropdown ml-auto">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                      <button  class="dropdown-item text-black" type="submit" formaction="/Accept_orderv">Accept</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/Prepaedv">prepared</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/Reject_orderv">Reject</button>
                                  </div>
                              </div>
                          </div>
                      </td>
