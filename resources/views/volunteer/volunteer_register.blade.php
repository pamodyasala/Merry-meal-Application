...
<div class="container" id="container">
	...
	<div class="form-container sign-up-container">
		<form action = "/volunteer_insert" method = "post">
            @csrf <!-- {{ csrf_field() }} -->
      ...
      <input type="text" id="Working_hours" name="Working_hours" placeholder="Expected number of hours worked per week" required/>
	...
	<div class="form-container sign-in-container">
		<form action="/volunteer_log" method="post">
            @csrf <!-- {{ csrf_field() }} -->
			<h1>Sign in</h1>
            <br>
