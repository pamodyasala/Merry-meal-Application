      ...
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
            <img src="images/LOGO 2 new.png" style="width:300px;height:150px;">
              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Welcome Member!</h1>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="/member_profile" class="smoothScroll">Profile</a></li>
                      ...
                      <td>
                          <div class="media align-items-center">
                              ...
                              <div >
                                  ...
                                  <p class="mb-0 ">Member ID:Member_{{ $oder->Menu_Id }} </p>
                              </div>
                          </div>
                      </td>
                      <td>
