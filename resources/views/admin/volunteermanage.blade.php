      ...
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#"> <i class="fa fa-edit"></i> Edit profile</a></li>
              ...
              <li class="active"><a href=volunteermanage> <i class="fa fa-edit"></i> Volunteers</a></li>
          </ul>
      </div>
  </div>
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          <div class="bio-graph-heading" style="background-image:url('https://cdnimg.webstaurantstore.com/images/articles/359/blog-cheftypes_header.jpg'); opacity: 0.8;">
              <h3 style="color: black;"><b>Volunteer Management</b></h3> <br>
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                id="volunteer" name="volunteer" value={{ $volunteer->Volunteer_Id }} readonly><br>
                                ...
                                <div >
                                    <h4 class="mt-0 mb-2">{{ $volunteer->Name }}</h4>
                        ...
                        <td>
                          <div>
                            <h4 class="mb-0">{{ $volunteer->Email }}</h4>
                            <h4 class="mb-0">{{ $volunteer->Address }}</h4>
                          </div>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $volunteer->Contact }}</h4>
                            <h4 class="mb-0 fs-20 d-inline-block">NIC:{{ $volunteer->NIC }}</h4>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">Age:{{ $volunteer->Age }}</h4>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a class="btn text-warning" href="javascript:void(0);">{{ $volunteer->Account_status }}</a>
                                <li class="dropdown">
                                    ...
                                    <button  class="dropdown-item text-black" type="submit" formaction="/volunteer_active">Activate</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/volunteer_deactivate">Deactivate</button>
