...
<div class="row">
      ...
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#"> <i class="fa fa-edit"></i> Edit profile</a></li>
              ...
              <li class="active"><a href=caregivermanage> <i class="fa fa-edit"></i> Care Giver</a></li>
              <li><a href=partnermanage> <i class="fa fa-edit"></i>Partners </a></li>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          <div class="bio-graph-heading" style="background-image:url('https://www.shutterstock.com/image-photo/care-worker-serving-dinner-elderly-260nw-1768875746.jpg'); opacity: 0.8; background: -webkit-linear-gradient(to left, #332042 , #B2BEB5);">
              <h3 style="color: rgb(0, 0, 0);"><b>Care Giver Management</b></h3> <br>
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="table-responsive">
                ...
                <form action = "/caregiver_active" method = "post">
                  @csrf <!-- {{ csrf_field() }} -->
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                id="caregiver_Id" name="caregiver_Id" value={{ $caregiver->Caregiver_Id }} readonly>
                                ...
                                <div >
                                    <h4 class="mt-0 mb-2">   {{ $caregiver->Name }}</h4>
                        ...
                        <td>
                          <div>
                            <h4 class="mb-0">{{ $caregiver->Email }}</h4>
                            <h4 class="mb-0">{{ $caregiver->Address }}</h4>
                          </div>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $caregiver->Contact }}</h4>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">Member Id:{{ $caregiver->Member_Id }}</h4>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a class="btn text-warning" href="javascript:void(0);">{{ $caregiver->Account_status }}</a>
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                      ...
                                      <button  class="dropdown-item text-black" type="submit" formaction="/caregiver_active">Activate</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/caregiver_deactivate">Deactivate</button>
