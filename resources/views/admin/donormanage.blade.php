...
<div class="row">
      ...
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#"> <i class="fa fa-edit"></i> Edit profile</a></li>
              ...
              <li class="active"><a href=donormanage> <i class="fa fa-edit"></i> Donors</a></li>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
        <div class="bio-graph-heading" style="background-image:url('https://static.vecteezy.com/system/resources/thumbnails/007/277/360/small/donate-icon-in-gradient-style-donation-icon-set-vector.jpg'); opacity: 0.8;">
            <h3 style="color: black;"><b>Donor Management</b></h3> <br>
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                <div >
                                    <h4 class="mt-0 mb-2">John Summit</h4>
                                    <p class="mb-0 ">01</p>
                                </div>
                            </div>
                        </td>
                        <td>
                          <div>
                            <h4 class="mb-0">example@gmail.com</h4>
                            <h4 class="mb-0">South Corner, B124, SriLanka</h4>
                          </div>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">071123456</h4>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">Medical Details</h4>
                        </td>
                        <td>
