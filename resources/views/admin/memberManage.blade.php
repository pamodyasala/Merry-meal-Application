...
<div class="row">
  <div class="profile-nav col-md-3">
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li class="active"><a href=memberManage> <i class="fa fa-edit"></i> Members</a></li>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          <div class="bio-graph-heading" style="background-image:url('https://devotedguardians.com/wp-content/uploads/2021/04/at-what-point-is-a-person-considered-elderly-980x400.jpg'); opacity: 0.8;">
              <h3 style="color: black;"><b>Member Management</b></h3> <br>
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                <div >
                                    <h4 class="mt-0 mb-2">{{ $member->Name }}</h4>
                        ...
                        <td>
                          <div>
                            <h4 class="mb-0">{{ $member->Email }}</h4>
                            <h4 class="mb-0">{{ $member->Address }}</h4>
                          </div>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $member->Contact }}</h4>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $member->Medical_details }}</h4>
                            <h4 class="mb-0 fs-20 d-inline-block">Age:{{ $member->Age }}</h4>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a class="btn text-warning" href="javascript:void(0);">{{ $member->Account_status }}</a>
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                      ...
                                      <button  class="dropdown-item text-black" type="submit" formaction="/member_active">Activate</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/member_deactivate">Deactivate</button>
                                      <button class="dropdown-item text-black" type="submit" formaction="/member_edit">Edit</button>
                                    </div>
                                </li>
                            </div>
                        </td>
