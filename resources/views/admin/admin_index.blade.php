  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="/admin_profile" class="smoothScroll">Management</a></li>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown ml-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <button  class="dropdown-item text-black" type="submit" formaction="/Accept_order">Accept</button>
                                    <button class="dropdown-item text-black" type="submit" formaction="/Prepaed">prepared</button>
                                    <button class="dropdown-item text-black" type="submit" formaction="/Reject_order">Reject</button>
                                </div>
                            </div>
                        </div>
                    </td>
