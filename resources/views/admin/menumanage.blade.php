    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="#menu" class="smoothScroll">Menu</a></li>
...
<div class="row">
      ...
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#"> <i class="fa fa-edit"></i> Edit profile</a></li>
              ...
              <li class="active"><a href=menumanage> <i class="fa fa-edit"></i> Menus</a></li>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          <div class="bio-graph-heading" style="background-image:url('https://www.shutterstock.com/image-photo/top-view-fully-set-rustic-260nw-772641289.jpg'); opacity: 0.8;">
              <h3 style="color: black;"><b>Menu Management</b></h3> <br>
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                id="Menu_Id" name="Menu_Id" value={{ $menu->Menu_Id }} readonly><br>
                        ...
                        <td>
                          <div>
                            <h4 class="mb-0">{{ $menu->Description }}</h4>
                            <h4 class="mb-0">{{ $menu->Category }}</h4>
                          </div>
                        </td>

                        <td>
                            <div class="d-flex align-items-center">
                                <a class="btn text-warning" href="javascript:void(0);">{{ $menu->Availability }}</a>
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <button  class="dropdown-item text-black" type="submit" formaction="/menue_available">Availablel</button>
                                        <button class="dropdown-item text-black" type="submit" formaction="/menue_notavailable">Not Available</button>
