...
<div class="row">
      ...
      <div class="panel" >
          ...
          <ul class="nav nav-pills nav-stacked">
            <li><a href="#"> <i class="fa fa-edit"></i> Edit profile</a></li>
              ...
              <li class="active" ><a href=ridermanage> <i class="fa fa-edit"></i> Riders</a></li>
  ...
  <div class="profile-info col-md-9">
      ...
      <div class="panel">
          <div class="bio-graph-heading" style="background-image:url('https://newsbytes.ph/wp-content/uploads/2020/05/Riders-and-Manulife.jpg'); opacity: 0.8;">
              <h3 style="color: black;"><b>Rider Management</b></h3> <br>
                    ...
                    <tr>
                        <td>
                            <div class="media align-items-center">
                                ...
                                id="rider" name="rider" value={{ $rider->Rider_Id }} readonly><br>
                                ...
                                <div >
                                    <h4 class="mt-0 mb-2">{{ $rider->Name }}</h4>
                                    <p class="mb-0 ">{{ $rider->Name }}</p>
                                </div>
                            </div>
                        </td>
                        <td>
                          <div>
                            <h4 class="mb-0">{{ $rider->Email }}</h4>
                            <h4 class="mb-0">{{ $rider->Address }}</h4>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $rider->Contact }}</h4>
                          </div>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $rider->License }}</h4>
                        </td>
                        <td>
                            <h4 class="mb-0 fs-20 d-inline-block">{{ $rider->Driverable_vehicles }}</h4>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a class="btn text-warning" href="javascript:void(0);">{{ $rider->Account_status }}</a>
                                <li class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <button  class="dropdown-item text-black" type="submit" formaction="/rider_active">Activate</button>
                                        <button class="dropdown-item text-black" type="submit" formaction="/rider_deactivate">Deactivate</button>
